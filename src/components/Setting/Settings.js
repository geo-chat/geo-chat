...
import { deleteAccount, logout, editUsername, editImg, editHexcolor, editPassword } from '../../store';
...
export default connect(mapStateToProps, { deleteAccount, logout, editUsername, editImg, editHexcolor, editPassword })(
	Settings
);
